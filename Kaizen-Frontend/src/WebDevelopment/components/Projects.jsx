...
const Projects = () => {
  return (
    <Container w="100%" maxW="full" centerContent overflow="hidden" mt="100px" id="project">
      <Heading color={"gray.800"} fontFamily={"Nunito,sans-serif"} >
      Delivered projects
      </Heading>
      <SimpleGrid
        color={"white"}
       boxShadow={"0px 1px 25px -5px rgb(0 0 0 / 48%), 0 10px 10px -5px rgb(0 0 0 / 43%)"}
      ...
      >
        <Box ml="10px" mb="10px" padding="20px 20px 20px 20px">
          <Box textAlign={"left"}>
            <Heading fontSize={"23px"} color="blue.500" fontFamily={"sans-serif"}>
              Reliance Clone
            </Heading>
            <Text color="gray.700">
      ...
      >
        <Box ml="10px" mb="10px" padding="20px 20px 20px 20px">
          <Box textAlign={"left"}>
            ...
            <Text color="gray.700">Cartlane is Indian online Jewllery Retailer. There are thousands of Jewellery Items.</Text>
