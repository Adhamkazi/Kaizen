...
const HirePage = () => {
  ...
  return (
    <div    >
      <SimpleGrid data-aos="fade-up"  columns={{ base: 1, md: 2 }} w={"90%"} margin={"auto"} spacing={3} alignItems={"center"} justifyItems={"center"} order={{ base: -1, md: 2 }}  fontFamily={"Plus Jakarta Sans"}>
        <Box order={{ base: 2, md: 1 }}  padding={{base:"0px",md:"40px"}}display="flex" flexDirection="column"  >
          <Box data-aos="fade-up"  >
            ...
            <Text mt={{base:"10px",md:"20px"}} textAlign={"left"} fontSize={{base:"20px",md:"20px"}}   color={"#1E344B"}>
          ...
          <SimpleGrid columns={{base:1,md:2}} fontSize={{base:"18px",md:"17px"}} mt={"40px"} fontWeight={350}    color={"#1E344B"} justifyContent={"space-around"} rowGap={{base:"10px",md:"25px"}} >
        ...
        <Box order={{ base: 1, md: 2 }} mt={{base:"60px"}} data-aos="fade-up" >
      ...
      <SimpleGrid data-aos="fade-up"  fontFamily={"Plus Jakarta Sans"} columns={{ base: 1, md: 2 }} w={"90%"} margin="auto" spacing={3} alignItems={"center"} justifyItems={"center"} order={{ base: -1, md: 2 }} >
      <Box order={{ base: 1, md: 1 }} mt={{base:"60px"}} data-aos="fade-up"  >
        ...
        <Box order={{ base: 1, md: 2 }}  padding={{base:"0px",md:"40px"}}display="flex" flexDirection="column"  >
          <Box>
            ...
            <Text mt={{base:"10px",md:"30px"}} textAlign={"left"} fontSize={{base:"20px",md:"20px"}}   color={"#1E344B"} >
          ...
          <SimpleGrid data-aos="fade-up"  columns={{base:1,md:1}}   color={"#1E344B"} fontSize={{base:"13px",md:"17px"}} mt={"40px"} fontWeight={350}   justifyContent={"space-around"} rowGap={{base:"10px",md:"15px"}} >
            <Flex alignItems={"center"} gap={"10px"} >
