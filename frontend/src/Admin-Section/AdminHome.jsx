    ...
    <Box minH="100vh" bg={useColorModeValue("gray.100", "gray.900")}>
      {isLoggedIn && (
        ...
        >
          ...
          <NavItem onClick={handleContactDataClick} color="white" variant="solid" bg="#37474F" mt="30px" >Contact Data</NavItem>
          <NavItem onClick={handleFormDataClick} color="white" variant="solid" bg="#37474F" mt="30px" >Form Data</NavItem>
        </Box>
      )}
      <Drawer
        autoFocus={false}
