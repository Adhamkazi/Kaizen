      ...
      <Box bg={"#E3F2FD"} id="home" mt={"70px"}  fontFamily={"Plus Jakarta Sans"} data-aos="fade-up" >
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }}   w={"100%"} data-aos="fade-up" >  
          <Box textAlign={"left"} bg={"white"}  padding={{base:"50px 30px 30px 30px ",md:"70px 40px 40px 40px "}} >
            ...
            <Text fontSize={{base:"20px",md:"21px"}} mt="30px" lineHeight={{base:"27px",md:"31px"}}   color={"#1E344B"}>
          ...
          <Box bg={"#F5F5F5"} padding={{base:"50px 30px 30px 30px ",md:"70px 40px 40px 40px "}} data-aos="fade-up"  >
            ...
            <Flex gap={"20px"} mt={"20px"}  alignItems={"center"} padding={"10px"} >
              <IconButton
                ...
                icon={<FcBusinessman />}
              />
              <Text fontSize={{base:"20px",md:"20px"}} fontWeight={"bold"} textAlign={"left"}   color={"#1E344B"}>
            ...
            <Text fontSize={{base:"20px",md:"18px"}}   color={"#1E344B"} textAlign={"left"} >Use our expertise to create a custom generation AI solution tailored to your product needs and business objectives</Text>
...
eCommerce Mobile Team
            ...
            <Text fontSize={{base:"20px",md:"18px"}} textAlign={"left"}  color={"#1E344B"} >Use our expertise to create a custom generation AI solution tailored to your product needs and business objectives</Text>
            <RouterLink to={"/contact"}>  <Button color={"#184CA8"} variant={"ghost"} mt={"30px"} size={"sm"}  fontSize={"20px"}   _hover={{textDecoration:"underline",color:"#184CA8"}}>Get Started</Button></RouterLink>
          </Box>
        </SimpleGrid>
      </Box>
