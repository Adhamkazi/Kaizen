...
const HowitWorks = () => {
  ...
  return (
    <div id="Howitwork">
      <Box bg={"#E3F2FD"} id="home" mt={"70px"}  fontFamily={"Plus Jakarta Sans"} data-aos="fade-up" data-aos-duration="1000">
        <Box
        padding="30px"
          textAlign={"left"}
        ...
        <SimpleGrid
          ...
          alignItems={"center"}
        >
          <Box padding={"30px"} data-aos="fade-up" data-aos-duration="1000" >
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }}   w={"100%"} data-aos="fade-up" data-aos-duration="1000">  
          ...
          {/* box-2 */}
          <Box bg={"#F5F5F5"} padding={{base:"50px 30px 30px 30px ",md:"70px 40px 40px 40px "}} data-aos="fade-up" data-aos-duration="1000" >
          ...
          <Box  bg="#E3F2FD" boxShadow={"md"} paddingTop={"100px"} padding={{base:"50px 30px 30px 30px",md:"70px 40px 40px 40px "}} data-aos="fade-up" data-aos-duration="1000">
          <Box  display={{base:"flex",md:"grid"}} alignItems={"center"} >
